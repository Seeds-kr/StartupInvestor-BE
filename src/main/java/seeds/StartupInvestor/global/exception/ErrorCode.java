package seeds.StartupInvestor.global.exception;
...
public enum ErrorCode {
    ...
    // Post
    INVALID_PAGE_NUMBER(HttpStatus.BAD_REQUEST, "P001", "존재하지 않는 페이지입니다."),
    ...
    LOGIN_USER_NOT_FOUND(HttpStatus.BAD_REQUEST, "J003",
